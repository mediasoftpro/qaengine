...
namespace Jugnoon.Settings
{
    ...
    {
        public static General GeneralSettings { get; set; }
        public static Aws AwsSettings { get; set; }
        public static Authentication AuthenticationSettings { get; set; }
        public static Contact ContactSettings { get; set; }
